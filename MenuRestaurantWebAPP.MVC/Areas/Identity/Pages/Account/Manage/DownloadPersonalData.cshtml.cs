...
namespace MenuRestaurantWebAPP.MVC.Areas.Identity.Pages.Account.Manage
{
    public class DownloadPersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("L'utente con il seguente ID '{UserId}' ha richiesto i suoi dati personali.", _userManager.GetUserId(User));
            ...
            Response.Headers.TryAdd("Content-Disposition", "attachment; filename=DatiPersonali.json");
